...
$_PageTitle = 'JasperReports PHP Client Class Documentation'; 
...
$iFrameSRC = '"docs/index.php"'; // Build the iFrame SRC URL
...
<!-- JasperServer Embed -->
<iframe src=<?php echo $iFrameSRC; ?> height="<?php echo $iFrameHeight; ?>" width="100%" marginheight="0" frameborder="0" scrolling="auto"></iframe>
