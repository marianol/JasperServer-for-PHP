<?php
/**
 * about.php Main Site Page.
 * show the menu and options
 *
 *
 * @author Mariano Luna
 * 
 * @copyright Copyright (c) 2011 - 2012 Jaspersoft Corporation - All rights reserved. 
 * 
...
// get the current readme.markdown
$file_data = file_get_contents( SITE_PATH . "/README.markdown");

$screen = Markdown($file_data);
?>
